...
Now open the [Arbor web app](http://arbor.arborworkflows.com). Drag and drop the two phelsuma data files on the blue "Browse or drop files" box to load them into your browser.
