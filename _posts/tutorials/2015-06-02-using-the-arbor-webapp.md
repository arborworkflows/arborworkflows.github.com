...
Follow the instructions on [this page]({{ site.baseurl}}/tutorials/creating-a-new-collection/) to create an account and start a private collection. Make sure to click on the "write" tab in your new collection, then come back here and finish the tutorial!
