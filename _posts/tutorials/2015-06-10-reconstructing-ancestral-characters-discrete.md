...
You will need the anolis example data files, anolis.phy and anolis.csv, from [Arbor datasets]({{ site.baseurl}}/documentation/datasets). Save those files somewhere on your computer.
