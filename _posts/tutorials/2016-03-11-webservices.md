...
Now, open an Arbor instance (e.g. [arbor.arborworkflows.com](http://arbor.arborworkflows.com/#)). You will now need to load in your species list. You can do this by dragging the file that you just downloaded onto the "Browse or drop files" box:
